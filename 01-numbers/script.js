...
const sum = numOne + numTwo + numThree; //possibile anche usare numOnePlusNumTwo + numThree
console.log(sum); // Output: 56

// 6. Imposta questa variabile come somma di numOne, numTwo, numThree diviso numOne
const numBytes = (numOne + numTwo + numThree) / numOne; //possibile anche usare (numOnePlusNumTwo + numThree) / numOne
